		...
		table.DataTable({
			...
			ajax: {
				...
				data: {
					...
					columnsDef: [
						'Property Address', 'Price', 'Sq ft', 'ARV',
						'Listing Type'],
                },
			},
			columns: [
                ...
                {data: 'arv'},
                {
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        return '<span class="label label-lg font-weight-bold' + status[data.listing_type].class + ' label-inline">' + status[data.listing_type].title + '</span>';
                    },
                }
			],
		});
...
jQuery(function(){
    ...
    $("#homeNav").removeClass('menu-item-active');
    $("#soldsActiveNav").removeClass('menu-item-active');
    $("#propertyListNav").removeClass('menu-item-active');
    $("#formsNav").addClass('menu-item-active');
    $("#cashBuyersNav").removeClass('menu-item-active');
    $("#privateLendersNav").addClass('menu-item-active');
    $("#rentalNav").removeClass('menu-item-active');

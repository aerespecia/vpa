...
<html lang="en">
	...
	<body id="kt_body" style="" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
						...
						<div class="subheader gutter-b subheader-transparent mt-10" id="kt_subheader">
							<div class="container d-flex flex-column">
								<div class="d-flex align-items-sm-end flex-column flex-sm-row mb-5">
									<h3 class="d-flex align-items-center text-dark mr-5 mb-0">Private Lenders</h3>
								</div>
							</div>
						</div>
                        <!--end::Subheader-->
                                            ...
                                            <form id="cashBuyersForm" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="fundAvailable" placeholder="Enter Budget" />
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label>Interest Rate</label>
                                                                <input type="text" class="form-control" id="interestRate" placeholder="Enter Budget" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label>What areas do you lend in?</label>
                                                                <div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" id="commnets" rows="3" placeholder="Enter Notes"></textarea>
                                                    </div>
                                                </div>
                                                <div class="card-footer">
                                                    <button type="reset" id="savePrivateLener" class="btn btn-primary mr-2">Submit</button>
                                                </div>
                                            </form>
                                            <!--end::Form-->
                                        </div>
        ...
        <script src="{{url('assets/js/pages/vpa/forms/private-lenders.js')}}"></script>

...
<html lang="en">
	...
	<body id="kt_body" style="" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
						...
						<div class="subheader gutter-b subheader-transparent mt-10" id="kt_subheader">
							<div class="container d-flex flex-column">
								<div class="d-flex align-items-sm-end flex-column flex-sm-row mb-5">
									<h3 class="d-flex align-items-center text-dark mr-5 mb-0">Rental Property</h3>
								</div>
							</div>
						</div>
                        <!--end::Subheader-->
                                            ...
                                            <form id="propertyForm" method="post" action="{{url('upload/store')}}" enctype="multipart/form-data">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label>Buyout Cost Per Unit</label>
                                                                <input type="number" class="form-control" id="buyout" placeholder="Enter ARV" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label>Units</label>
                                                                    <input type="number" class="form-control" id="units" placeholder="Enter Lot Size" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" class="form-control" id="capRate" placeholder="Enter Lot Size" />
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" class="form-control" id="rentPerSqft" placeholder="Enter Lot Size" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label>Projected Cap Rate</label>
                                                                <input type="number" class="form-control" id="projectedCapRate" placeholder="Enter Lot Size" />
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
        ...
        <script src="{{url('assets/js/pages/vpa/forms/rental.js')}}"></script>
